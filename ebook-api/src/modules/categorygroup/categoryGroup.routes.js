...
const {
  ...
  getCategoryGroupsSchema
} = require('./categoryGroup.validation');
 ...
 */
router.post('/',  uploadCategoryGroupImage, controller.createCategoryGroup);
 ...
 *     description: |
 *       Returns product groups available in the store.
 *       Supports pagination and optional search by group name.
 *     tags:
 *       - CategoryGroup
 *     parameters:
 *       - in: query
 ...
 *           type: string
 *           default: ''
 *         description: Search term to filter group name
 *     responses:
 *       200:
 *         description: Paginated product group list loaded successfully
 *         content:
 *           application/json:
 *             example:
 *               success: true
 ...
 *                   - groupid: 1
 *                     groupname: Fiction
 *                     imagepath: fiction.jpg
 *                     activecategorycount: 8
 *                   - groupid: 2
 *                     groupname: Science
 *                     imagepath: science.jpg
 *                     activecategorycount: 12
 *               message: Product group list loaded successfully
 *       500:
 *         description: Internal server error
 */
router.get('/', validateQuery(getCategoryGroupsSchema), controller.getAllCategoryGroups);
 ...
 *         description: Something went wrong
 */
router.put('/:id', validateBody(updateCategoryGroupSchema), uploadCategoryGroupImage,controller.updateCategoryGroup);
 ...
 *         description: Something went wrong
 */
router.delete('/:id', validateBody(deleteCategoryGroupSchema), controller.deleteCategoryGroup);
