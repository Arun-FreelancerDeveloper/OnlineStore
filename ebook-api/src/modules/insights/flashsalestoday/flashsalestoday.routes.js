...
/**
 * @swagger
 * /api/insights/flashsale:
 *   get:
 *     summary: Get Flash Sale Products
 *     description: >
 *       Returns today's flash sale products with pagination.
 ...
 *                 message:
 *                   type: string
 *                   example: Flash sale products fetched successfully
 *                 data:
 *                   type: object
 *                   properties:
 *                     currentPage:
 ...
 */
router.get('/', controller.getFlashSaleProducts);
