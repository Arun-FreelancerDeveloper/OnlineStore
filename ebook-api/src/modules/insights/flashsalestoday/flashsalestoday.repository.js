...
/**
 * <summary>
 * Retrieve flash sale product records for the insights dashboard.
 * </summary>
 * <param name="page">Page number.</param>
 * <param name="pageSize">Number of records per page.</param>
 * <returns>Promise resolving to paginated flash sale product data.</returns>
 */
exports.getFlashSaleProducts = async (page = 1, pageSize = 10) => {
  try {
