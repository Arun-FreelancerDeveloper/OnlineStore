...
const controller = require('./recommended.controller');

/**
 * @swagger
 * /api/insights/recommended:
 *   get:
 *     summary: Get Recommended Products
 *     description: >
 *       Returns recommended products with pagination.
 ...
 */
router.get('/', controller.getRecommendedProducts);
